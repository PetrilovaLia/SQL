...
-- akým spôsobom zistím, koľko sekúnd trvá jeden byte
-- matematické operácie
SELECT "Milliseconds", "Bytes", "Milliseconds" / "Bytes"
FROM "Track"
-- všetko je nula oba stĺpce sú typu INT - neviem 
-- jedna hodnota musí byť DECIMAL (FLOAT)
-- prekastovať

SELECT "Milliseconds", "Bytes", CAST("Bytes" AS DECIMAL), "Milliseconds" / "Bytes"
FROM "Track"
-- pribudol stĺpec Bytes s dátovým typom numeric

SELECT "Milliseconds", "Bytes", CAST("Bytes" AS DECIMAL), "Milliseconds" / CAST("Bytes" AS DECIMAL)
FROM "Track"
-- už počíta v novom stĺpci

-- aj sčítanie/ odčítanie
SELECT "Milliseconds", "Bytes", "Milliseconds" + "Bytes"
FROM "Track"

-- pomenovanie nového stĺpca pomocou ALIAS - AS
SELECT "Milliseconds", "Bytes", CAST("Bytes" AS DECIMAL), "Milliseconds" / CAST("Bytes" AS DECIMAL) AS podiel, "Milliseconds" + "Bytes" AS sucet 
FROM "Track"

SELECT "Milliseconds", "Bytes", "Milliseconds" + "Bytes" sucet
FROM "Track"
...
-- DISTINCT - jedinečné záznamy
-- v danom stĺpci sú 'jedinečné' hodnoty - 
-- viem spustiť nad jedným alebo viacerými stĺpcami
SELECT DISTINCT "AlbumId"
FROM "Track"

-- jedniečné kombinácie
